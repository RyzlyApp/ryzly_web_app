        ...
        <div className=" w-full h-[180px] bg-neonblue-500 p-4 flex items-center rounded-2xl " >
            <div className=" lg:w-auto w-full flex flex-col gap-3 " >
                <div className=" w-full flex "  >
                    {(!data?.country || !data?.about || data?.interests?.length === 0 || data?.interests?.length === 0 || !data?.phone || !data?.profilePicture || data?.skills?.length === 0 || !data?.username || data?.track?.length === 0 || data?.challenges?.length <= 0) ? (
                ...
                <div className=" flex gap-2 " >
                    {(!data?.country || !data?.about || data?.interests?.length === 0 || data?.interests?.length === 0 || !data?.phone || !data?.profilePicture || data?.skills?.length === 0 || !data?.username || data?.track?.length === 0) && (
