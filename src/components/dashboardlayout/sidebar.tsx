...
export default function Sidebar() {
    ...
    return (
        <div className={` ${pathname?.includes("/dashboard/challenges/create") ? " hidden " : " flex "} w-[280px] bg-violet-500 h-screen p-5  flex-col `}>
            <button
                onClick={() => router.push("/")}
                        ...
                        <div className=" border-b border-b-gray-200 pb-2 flex flex-col w-full">
                            ...
                            {/* {user?.userType !== "organization" && (
                                <button
                                    ...
                                    className=" px-3 w-full hidden h-[45px] gap-2 items-center lg:flex "
                                >
                                    <RiAddLine size={"20px"} />
                                    <p className=" font-medium text-violet-300 ">
                                        Become A Coach
