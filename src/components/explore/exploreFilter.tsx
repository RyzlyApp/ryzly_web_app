    ...
    return (
        <FormikProvider value={formik}>
            <div className=" w-full flex flex-col items-center pt-3 justify-center gap-6" >
                <div className=" max-w-[90%] lg:max-w-[80%] mx-auto w-full flex flex-col text-center space-y-4 xl:space-y-10 mb-4 sm:mb-6 xl:mb-10" >
                    ...
                    <p className=" text-violet-500 font-bold text-[48px]" >Discover Challenges</p>
