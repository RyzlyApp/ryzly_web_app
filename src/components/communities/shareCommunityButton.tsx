// src/components/shared/ShareCommunityBtn.tsx
"use client";
...
export default function ShareCommunityBtn({ id }: { id: string }) {
    ...
    const shareTo = (platform: "twitter" | "facebook" | "linkedin" | "whatsapp" | "copy") => {
        ...
        const text = encodeURIComponent("Check out this community!");
        ...
        if (platform === "copy") {
            ...
            addToast({ description: "Link copied!", color: "primary" });
            return;
        }
        ...
        <Popover placement="bottom-end" showArrow>
            ...
            <PopoverContent>
                <div className="flex flex-col gap-3 items-center p-2">
                    <p className="text-sm font-semibold">Share community</p>
