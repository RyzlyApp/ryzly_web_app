...
const DeleteCommunityModal = ({ isOpen, onClose }: DeleteCommunityModalProps) => {
    ...
    const { deleteGroup } = useCommunityGroup(false, communityId);

    // ✅ Pick the correct mutation & ID based on context
    const isGroup = !!groupId;
    const deleteMutation = isGroup ? deleteGroup : deleteCommunity;
    const targetId = isGroup ? groupId : communityId;
    const actionLabel = isGroup ? "Delete Group" : "Delete Community";
            ...
            <div className="flex flex-col items-center text-center">
                ...
                <div className="flex flex-col gap-3 w-full mt-6">
                    <Button
                        ...
                        isDisabled={deleteMutation.isPending || !targetId}
                        className="w-full rounded-full font-medium"
                    >
                        {deleteMutation.isPending ? "Deleting..." : actionLabel}
                    </Button>
